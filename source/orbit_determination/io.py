...
from orbit_determination.ext import days2mdhms, invjday, jday
from orbit_determination.propagation import sgp4init
...
def twoline2rv(longstr1, longstr2, whichconst, opsmode='i', satrec=None):
    ...
    if satrec is None:
        from orbit_determination.model import Satellite
        satrec = Satellite()
